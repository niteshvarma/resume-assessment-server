...
class PineconeVectorizer:
    def __init__(self) -> None:
        ...
        pinecone_index_name = os.getenv('PINECONE_INDEX', 'default-index')
        pinecone_namespace = os.getenv('PINECONE_NAMESPACE', 'resumes')
    ...
    def vectorize_and_store_resume(self, resume_id: str, text_resume: dict, metadata: dict):
        """
    ...
    def delete_resume(self, resume_id: str):
        ...
        try:
            ...
            self.pinecone_index.delete(resume_id)
